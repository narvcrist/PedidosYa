        ...
        || empty($_POST['cantidad'])){
            ...
            if($nombre_foto != ''){ //Condicion cuando no lleva foto  
                ...
                if($consulta_insert){
                    ...
                    $alert='<p class="mensage" style=" color: #FFF; background: #60A756; text-align: center;  border-radius: 5px;  padding: 4px 15px;">Producto guardado con éxito </p>';
                }else{
                    $alert='<p class="mensage" style=" color: #FFF; background: orange; text-align: center;  border-radius: 5px;  padding: 4px 15px;">Ocurrio un error al registrar el producto</p>';
                }
            }
    }
?>
    ...
    <h2>Registrar producto</h2>
        <div class="card">
            ...
            <div class="card-content p-2">
                <form class="ingresar" action="" method="post" enctype="multipart/form-data" data-role="validator" action="javascript:">
                <div class="form-group">
                        ...
                        ?>
                        <select name="proveedor" id='proveedor' class="unaVez"  data-validate="required">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" placeholder="Nombre del producto" data-validate="required"/>
                    </div>
                    <div class="form-group">
                        <label for="precio">Precio:</label>
                        <input type="text" name="precio" placeholder="Precio del producto" onkeypress="return solonumeros(event);" data-validate="required"/>
                    </div>
                    <div class="form-group">
                        <label for="cantidad">Cantidad:</label>
                        <input type="text" data-role="spinner" data-buttons-position="right" name="cantidad" data-min-value="10" data-max-value="500" name="cantidad" value="10"  onkeypress="return solonumeros(event);" data-validate="required"/>
                    </div>
                    <div class="form-group">
                        <div class="photo">
