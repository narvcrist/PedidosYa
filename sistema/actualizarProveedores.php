    ...
    if(!empty($_POST)){
        ...
        || empty($_POST['direccion'])){
            ...
            if($resultado > 0){
                ...
                if($consulta){
                    $alert='<p class="mensage" style=" color: #FFF; background: #60A756; text-align: center;  border-radius: 5px;  padding: 4px 15px;">Proveedor actualizado con éxito</p>';
                }else{
    ...
    <h2>Actualizar proveedor</h2>
        <div class="card">
            ...
            <form class="ingresar" action="" method="post" data-role="validator" action="javascript:">
                    ...
                    <a href="listaProveedores.php"><input type="button" class="button" value="Cancelar"></a>
