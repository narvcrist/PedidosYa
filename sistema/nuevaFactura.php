        ...
        <a href="#"><button class="button success btn_new_cliente"><span class="mif-add">&nbsp;</span>Nuevo tendero</button></a>
            ...
            <form name="form_new_cliente" id="form_new_cliente" class="datos">
                ...
                <div class="wd30">
                    ...
                    <input type="text" name="ced_cliente" id="ced_cliente" maxlength="10" placeholder="Número de cédula del tendero" required  onkeypress="return solonumeros(event);"/>
                </div>
                <div class="wd30">
                    <label for="nombre">Nombres:</label>
                    <input type="text" name="nom_cliente" id="nom_cliente" placeholder="Nombre del tendero" disabled required onkeypress="return soloLetras(event);"/>
                </div>
                <div class="wd30">
