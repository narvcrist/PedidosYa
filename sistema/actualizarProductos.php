        ...
        || empty($_POST['cantidad']) || empty($_POST['id']) || empty($_POST['foto_actual']) || empty($_POST['foto_remove'])){
            ...
            if($nombre_foto != ''){ //Condicion cuando no lleva foto  
                ...
                if($consulta_update){
                    ...
                    $alert='<p class="mensage" style=" color: #FFF; background: #60A756; text-align: center;  border-radius: 5px;  padding: 4px 15px;">Producto actualizado con éxito </p>';
                }else{
            ...
            <div class="card-content p-2">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" placeholder="Nombre del producto" value="<?php echo $data_producto['pro_descripcion']; ?>" data-validate="required"/>
                    </div>
                    <div class="form-group">
                        <label for="precio">Precio:</label>
                        <input type="text" name="precio" placeholder="Precio del producto" value="<?php echo $data_producto['pro_precio']; ?>" data-validate="required" onkeypress="return solonumeros(event);"/>
                    </div>
                    <div class="form-group">
                        <label for="cantidad">Cantidad:</label>
                        <input type="text" data-role="spinner" data-buttons-position="right" name="cantidad" data-min-value="10" data-max-value="500" value="<?php echo $data_producto['pro_stock']; ?>" data-validate="required" onkeypress="return solonumeros(event);"/>
                    </div>
                    <div class="form-group">
                        <div class="photo">
