    ...
    if(!empty($_POST)){
        ...
        || empty($_POST['rol'])){
            ...
            if($resultado > 0){
                ...
                if($consulta){
                    $alert='<p class="mensage" style=" color: #FFF; background: #60A756; text-align: center;  border-radius: 5px;  padding: 4px 15px;">Usuario actualizado con éxito </p>';
                }else{
            ...
            <div class="card-content p-2">
                <form class="ingresar" action="" method="post"  data-role="validator" action="javascript:">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="correo" placeholder="Correo eléctronico" value="<?php echo $correo; ?>" data-validate="required email"/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="usuario" placeholder="Usuario" value="<?php echo $usuario; ?>" data-validate="required"/>
                    </div>
                    <div class="form-group">
