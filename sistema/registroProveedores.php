<?php
    ...
    if(!empty($_POST)){
        ...
        || empty($_POST['direccion'])){
            ...
            if($resultado > 0){
                $alert='<p class="mensage" style=" color: #FFF; background: orange; text-align: center;  border-radius: 5px;  padding: 4px 15px;">El proveedor ya existe</p>';
            }else{
                ...
                if($consulta_insert){
                    $alert='<p class="mensage" style=" color: #FFF; background: #60A756; text-align: center;  border-radius: 5px;  padding: 4px 15px;">Proveedor registrado con éxito </p>';
                }else{
                    $alert='<p class="mensage" style=" color: #FFF; background: red; text-align: center;  border-radius: 5px;  padding: 4px 15px;">Ocurrio un error al registrar al proveedor</p>';
                }
            }
        }
    }
            ...
            <div class="card-content p-2">
                <form class="ingresar" action="" method="post" data-role="validator" action="javascript:">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="telefono" placeholder="Ingrese el número telefónico" />
                    </div>
                    <div class="form-group">
